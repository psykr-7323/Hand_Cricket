  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-4 right-4 z-40 inline-flex items-center gap-2 rounded-full border px-4 py-3 text-sm font-bold uppercase tracking-broadcast shadow-lg backdrop-blur ${accentBorderClass} ${accentClass}`}
      >
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 20 }}
              className="fixed inset-x-3 bottom-3 z-50 flex max-h-[70vh] flex-col overflow-hidden rounded-2xl border border-arena-outline-variant/20 bg-arena-surface shadow-2xl sm:inset-x-auto sm:right-4 sm:top-[96px] sm:bottom-4 sm:w-[340px]"
            >
